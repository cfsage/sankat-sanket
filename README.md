...
- Do not expose server-only secrets (e.g., `SUPABASE_SERVICE_ROLE_KEY`, Twilio tokens) to the client or via any API responses.
- The Supabase anon key is intended for client-side usage but should not be returned by server APIs.
